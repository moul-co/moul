	...
	return function (Vips) {
		...
		function rb() {
			return va || (!ia && !ja) || 'function' != typeof fetch
				...
				: fetch(pb, { credentials: 'same-origin' })
						.then(function (a) {
							if (!a.ok) throw "failed to load wasm binary file at '" + pb + "'"
		...
		var FS = {
			...
			readFile: (a, b = {}) => {
				...
				FS.read(d, e, 0, a, 0)
				'utf8' === b.encoding ? (c = Ba(e)) : 'binary' === b.encoding && (c = e)
				FS.close(d)
				return c
			},
			writeFile: (a, b, c = {}) => {
		...
		var H = {
			...
			Jb: {
				...
				read: function (a, b, c, d) {
					...
					e && e == a.Pb.length && (e--, (a.Pb[e].offset = 0), (a.Pb[e].Yb = 0))
					a.Pb.splice(0, e)
					return c
				},
				write: function (a, b, c, d) {
		...
		function Q(a, b, c = {}) {
			...
			od[a] = b
			delete pd[a]
			nd.hasOwnProperty(a) && ((b = nd[a]), delete nd[a], b.forEach((e) => e()))
		}
		function yd(a) {
			switch (a) {
				case 1:
		...
		function Qd(a) {
			...
			if ('undefined' === typeof FinalizationRegistry) return (Qd = (b) => b), a
		...
		function Wd(a, b) {
			if (null === b) return this.md && T('null is not a valid ' + this.name), 0
